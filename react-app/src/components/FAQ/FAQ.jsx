    ...
    general: [
        {
            ...
            description:
                "This is a clone of Instagram, developed during Week 21 and Week 22 of the 24 week Full Stack engineering program at App Academy, created to demonstrate full-stack development skills.",
        },
        {
            title: "What technologies are used?",
            description:
                "This project is built using React, Redux, Flask, PSQL, sqlalchemy, CSS, and AWS S3.",
        },
        {
        ...
        {
            title: "Is this affiliated with Instagram?",
            description:
                "No, this is a non-commercial clone project built for educational purposes. It is not associated with Instagram or any of its affiliates.",
        },
    ],
};
